...
import 'package:halldenapp/models/classes/task.dart';
import 'package:halldenapp/models/global.dart';
import 'package:halldenapp/models/widgets/intray_todo.dart';
...
class _IntrayPageState extends State<IntrayPage> {
  ...
  Widget _buildListTitle(BuildContext context, Task item) {
    return ListTile(
      key: Key(item.taskId),
      title: IntrayTodo(title: item.title, keyValue: item.taskId),
    );
  }
